...
class FormMenuNiveles(Form):
    def __init__(self,save_file, name,master_surface,x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background= None, imagen_background = None, color_border= None,active=False):
        ...
        self.boton1 = Button(master=self,x=20,y=20,w=750,h=180,image_background=PATH_RECURSOS + r"\background\Forest0.png",on_click=self.click_nivel,on_click_param=1, active=obtener_estado_nivel(self.save_file,1))
        self.boton2 = Button(master=self,x=20,y=220,w=750,h=180,image_background=PATH_RECURSOS + r"\background\Snow3.png",on_click=self.click_nivel,on_click_param=2, active=obtener_estado_nivel(self.save_file,2))
        self.boton3 = Button(master=self,x=20,y=420,w=750,h=180,image_background=PATH_RECURSOS + r"\background\Cave0.png",on_click=self.click_nivel,on_click_param=3, active=obtener_estado_nivel(self.save_file,3))
        self.boton4 = Button(master=self,x=20, y=670, w=120,h =50,image_background=None, on_click=self.retroceder, text="atras", font_size= 50, font_color=COLOR_TEXTO_MENU) 
