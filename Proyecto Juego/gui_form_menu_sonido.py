...
class FormSonido(Form):
    def __init__(self, name, master_surface, x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background= None, imagen_background = None, color_border= None,active=False):
        ...
        self.sound_bar = ElementBar(master=self,x=500,y=190,w=500,h=70,color_background=None,color_border=None, value= 10 ,value_max = 10, image_background=PATH_RECURSOS + r"\gui\gray_bar.png",element= PATH_RECURSOS + r"\gui\green.png")
        ...
        self.effect_bar = ElementBar(master=self,x=500,y=490,w=500,h=70,color_background=None,color_border=None, value=10, value_max = 10, image_background= PATH_RECURSOS + r"\gui\gray_bar.png",element= PATH_RECURSOS + r"\gui\green.png")
    ...
    def change_sound(self, incremento):
        ...
        pygame.mixer.music.set_volume(self.sound_bar.value/10)
