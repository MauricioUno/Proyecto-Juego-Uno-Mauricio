...
class FormSonido(Form):
    def __init__(self, name, master_surface, x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background= None, imagen_background = None, color_border= None,active=False):
        ...
        self.sound_bar = ElementBar(master=self,x=500,y=190,w=500,h=70,color_background=None,color_border=None, value=(pygame.mixer.music.get_volume()*20) ,value_max = 10, image_background=PATH_RECURSOS + r"\gui\gray_bar.png",element= PATH_RECURSOS + r"\gui\green.png")
        ...
        self.effect_bar = ElementBar(master=self,x=500,y=490,w=500,h=70,color_background=None,color_border=None, value=(self.sounds_dict["click"].get_volume()*40), value_max = 10, image_background= PATH_RECURSOS + r"\gui\gray_bar.png",element= PATH_RECURSOS + r"\gui\green.png")

        self.back = Button(master=self,x=20, y=670, w=120,h =50,image_background=None, on_click=self.retroceder, on_click_param="options",text="atras", font_size= 50, font_color=COLOR_TEXTO_MENU) 
