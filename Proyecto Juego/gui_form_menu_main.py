...
class FormMenuMain(Form):
    def __init__(self,name,master_surface,x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background= None, imagen_background = None, color_border= None,active=True):
        ...
        self.boton3 = Button(master=self, x = 610, y = 300, w = 280, h = 100, on_click=self.start, on_click_param="levels",text="START", font_size= 100, font_color=COLOR_TEXTO_MENU)
    ...
    def start(self, parametro):
        crear_data_base_niveles()
        FormMenuNiveles(name="levels",master_surface = self.master_surface, imagen_background =PATH_RECURSOS + r"\background\Pradera1.png")
